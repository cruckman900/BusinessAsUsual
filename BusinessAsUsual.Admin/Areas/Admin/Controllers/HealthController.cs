...
namespace BusinessAsUsual.Admin.Areas.Admin.Controllers
{
    ...
    public class HealthController : Controller
    {
        ...
        /// <summary>
        /// Initializes a new instance of the HealthController class using the specified health metrics provider.
        /// </summary>
        /// <param name="metrics">The health metrics provider used to supply health data for this controller. Cannot be null.</param>
