...
/// <summary>Defines how mobile apps should render a create/edit form screen.</summary>
...
/// <summary>A form field definition (text, email, date, select, number, currency, ...).</summary>
