namespace Finance.Contracts.Navigation;

/// <summary>
/// Defines the navigation structure for the Finance module in mobile apps.
...
/// registered screen key (e.g. "invoice-list") and an optional web route.
/// </summary>
