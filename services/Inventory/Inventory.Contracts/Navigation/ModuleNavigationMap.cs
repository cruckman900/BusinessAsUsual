namespace Inventory.Contracts.Navigation;

/// <summary>
/// Defines the navigation structure for the Inventory module in mobile apps.
...
/// registered screen key (e.g. "product-list") and an optional web route.
/// </summary>
