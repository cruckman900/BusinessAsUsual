...
{
    /// <inheritdoc />
    public partial class ExpandedHrModel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagerRole = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DepartmentManagers_Employees_ManagerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartmentManagers_EndDate",
                table: "DepartmentManagers",
                column: "EndDate");

            migrationBuilder.CreateIndex(
                name: "IX_DepartmentManagers_IsPrimary",
                table: "DepartmentManagers",
                column: "IsPrimary");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeDepartments_IsPrimary",
                table: "EmployeeDepartments",
                column: "IsPrimary");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeDepartments_LeftDate",
                table: "EmployeeDepartments",
                column: "LeftDate");
