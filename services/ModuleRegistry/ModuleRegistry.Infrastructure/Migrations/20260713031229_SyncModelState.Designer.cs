...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModuleRegistry.Domain.Entities.ModuleMetadata", b =>
                {
                    b.OwnsMany("ModuleRegistry.Domain.Entities.NavigationItem", "NavigationItems", b1 =>
                        {
                            b1.Property<Guid>("ModuleMetadataId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("ModuleMetadataId", "__synthesizedOrdinal");

                            b1.ToTable("Modules");

                            b1.ToJson("NavigationItems");

                            b1.WithOwner()
                                .HasForeignKey("ModuleMetadataId");
                        });
