...
{
    /// <summary>
    /// Represents a customizable setting associated with a specific user role.
    /// </summary>
    public class CompanyUserRoleSetting
    {
        /// <summary>
        /// Unique identifier for the role setting entry.
        /// </summary>
        [Key]
        ...
        /// <summary>
        /// Identifier of the role this setting belongs to.
        /// </summary>
        ...
        /// <summary>
        /// The role this setting belongs to.
        /// </summary>
